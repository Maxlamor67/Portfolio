...
export default function Contact() {
    ...
    {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/maxime-lamorlette-467955328/',
        icon: <LinkedInIcon />,
        color: '#0077b5'
    },
    {
        name: 'Email',
        url: 'mailto:maxime.lamorlette2005@gmail.com',
        icon: <EmailIcon />,
        color: '#EA4335'
    },
    {
        name: 'Github',
        url: 'https://github.com/Maxlamor67',
        icon: <GithubIcon />,
        color: '#333'
    }
  ];
  ...
  return (
    <div className="contact-page">
        <div className="contact-header">
            ...
            Pour toute demande ou nouveau projet, n'hésitez pas à me contacter.
        </p>
        </div>
